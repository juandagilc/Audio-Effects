...
RobotizationWhisperizationAudioProcessorEditor::RobotizationWhisperizationAudioProcessorEditor (RobotizationWhisperizationAudioProcessor& p)
...
RobotizationWhisperizationAudioProcessorEditor::~RobotizationWhisperizationAudioProcessorEditor()
{
}

//==============================================================================

void RobotizationWhisperizationAudioProcessorEditor::paint (Graphics& g)
{
    g.fillAll (getLookAndFeel().findColour (ResizableWindow::backgroundColourId));
}

void RobotizationWhisperizationAudioProcessorEditor::resized()
{
